...
export class EmuWasm {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(EmuWasm.prototype);
        obj.__wbg_ptr = ptr;
    ...
    */
    keypress(event, pressed) {
        wasm.emuwasm_keypress(this.__wbg_ptr, addHeapObject(event), pressed);
    }
    /**
    * @param {Uint8Array} data
    */
    load_game(data) {
        wasm.emuwasm_load_game(this.__wbg_ptr, addHeapObject(data));
    }
    /**
    * @param {number} scale
    */
