...
// this tag indicates that the struct needs to be configured for webassembly
// we need to prefix anything that will be called within javascript with this tag
#[wasm_bindgen]
pub struct EmuWasm {
    chip8: Emu,
